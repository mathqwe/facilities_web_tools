...
- O projeto agora inclui `.streamlit/config.toml` para forçar tema claro no Streamlit Cloud.
- A sidebar foi ocultada para remover o logo lateral e evitar contraste ruim no deploy.
- O CSS foi reforçado para manter textos, radio buttons e uploader legíveis mesmo quando o navegador estiver em modo escuro.
